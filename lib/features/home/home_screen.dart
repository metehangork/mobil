...
class HomeScreen extends StatelessWidget {
  ...
  static final sampleRooms = [
    {
      'name': 'Matematik 101',
      'lastMessage': 'Ödev 3 hataları tartışıldı.',
      'time': '09:12',
      'unreadCount': 3
    },
    {
      'name': 'Fizik Lab',
      'lastMessage': 'Raporlar upload edildi.',
      'time': '08:50',
      'unreadCount': 0
    },
    {
      'name': 'Bilgisayar Müh',
      'lastMessage': 'Kod paylaşan var mı?',
      'time': 'Dün',
      'unreadCount': 7
    },
  ];
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _ActiveRoomChip(
                      roomName: r['name'] as String,
                      unread: r['unreadCount'] as int);
                },
              ),
            ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                      child: Text(
                          'Ders duyuruları ve sabit mesajlar burada görünür.')),
                ],
              ),
            ),
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading:
                        CircleAvatar(child: Text((room['name'] as String)[0])),
                    title: Text(room['name'] as String,
                        style: const TextStyle(fontWeight: FontWeight.w600)),
                    subtitle: Text(room['lastMessage'] as String,
                        maxLines: 1, overflow: TextOverflow.ellipsis),
                    trailing: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(room['time'] as String,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
              icon: Icon(Icons.chat_bubble_outline), label: 'Sohbet'),
          BottomNavigationBarItem(icon: Icon(Icons.search), label: 'Keşfet'),
          BottomNavigationBarItem(
              icon: Icon(Icons.add_circle_outline), label: 'Yeni'),
          BottomNavigationBarItem(
...
class _ActiveRoomChip extends StatelessWidget {
  ...
  final int unread;
  const _ActiveRoomChip({required this.roomName, required this.unread});
