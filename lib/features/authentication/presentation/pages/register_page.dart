...
class _RegisterPageState extends State<RegisterPage> {
      ...
      body: BlocConsumer<AuthBloc, AuthState>(
        listener: (context, state) {
          ...
          if (state is AuthAuthenticated) {
            debugPrint('✅ AuthAuthenticated - Navigate to home');
            context.go('/home');
                  ...
                  SearchableDropdown(
                    ...
                    onChanged: (value, id) {
                      setState(() {
                        ...
                        _selectedDepartment =
                            null; // Üniversite değişince bölümü sıfırla
  ...
  void _handleRegister() {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      debugPrint(
          '🏫 School ID: $_selectedUniversityId, Department ID: $_selectedDepartmentId');
      context.read<AuthBloc>().add(
            AuthRegisterEvent(
              ...
              schoolId: _selectedUniversityId,
